// https://itk.org/ITKExamples/src/Registration/Metricsv4/PerformRegistrationOnVectorImages/Documentation.html
...
int main(int argc, char *argv[])
{
  ...
  constexpr unsigned int NumberOfPixelComponents = 6;
